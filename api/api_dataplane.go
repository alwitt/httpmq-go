...
func (r ApiV1DataAliveGetRequest) Execute() (ApisStandardResponse, *_nethttp.Response, error) {
...
func (a *DataplaneApiService) V1DataAliveGetExecute(r ApiV1DataAliveGetRequest) (ApisStandardResponse, *_nethttp.Response, error) {
	var (
...
func (r ApiV1DataReadyGetRequest) Execute() (ApisStandardResponse, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return ApisStandardResponse
func (a *DataplaneApiService) V1DataReadyGetExecute(r ApiV1DataReadyGetRequest) (ApisStandardResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
