...
func (r ApiV1DataAliveGetRequest) Execute() (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
	return r.ApiService.V1DataAliveGetExecute(r)
}
...
*/
func (a *DataplaneApiService) V1DataAliveGet(ctx _context.Context) ApiV1DataAliveGetRequest {
	return ApiV1DataAliveGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DataplaneApiService) V1DataAliveGetExecute(r ApiV1DataAliveGetRequest) (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DataplaneApiService.V1DataAliveGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/data/alive"
...
func (r ApiV1DataReadyGetRequest) Execute() (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
	return r.ApiService.V1DataReadyGetExecute(r)
}
...
*/
func (a *DataplaneApiService) V1DataReadyGet(ctx _context.Context) ApiV1DataReadyGetRequest {
	return ApiV1DataReadyGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//  @return GoutilsRestAPIBaseResponse
func (a *DataplaneApiService) V1DataReadyGetExecute(r ApiV1DataReadyGetRequest) (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DataplaneApiService.V1DataReadyGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/data/ready"
...
func (r ApiV1DataStreamStreamNameConsumerConsumerNameAckPostRequest) HttpmqRequestID(httpmqRequestID string) ApiV1DataStreamStreamNameConsumerConsumerNameAckPostRequest {
	r.httpmqRequestID = &httpmqRequestID
	return r
}

func (r ApiV1DataStreamStreamNameConsumerConsumerNameAckPostRequest) Execute() (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return GoutilsRestAPIBaseResponse
func (a *DataplaneApiService) V1DataStreamStreamNameConsumerConsumerNameAckPostExecute(r ApiV1DataStreamStreamNameConsumerConsumerNameAckPostRequest) (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
	var (
...
// User provided request ID to match against logs
func (r ApiV1DataStreamStreamNameConsumerConsumerNameGetRequest) HttpmqRequestID(httpmqRequestID string) ApiV1DataStreamStreamNameConsumerConsumerNameGetRequest {
	r.httpmqRequestID = &httpmqRequestID
	return r
}
...
// User provided request ID to match against logs
func (r ApiV1DataSubjectSubjectNamePostRequest) HttpmqRequestID(httpmqRequestID string) ApiV1DataSubjectSubjectNamePostRequest {
	r.httpmqRequestID = &httpmqRequestID
	return r
}

func (r ApiV1DataSubjectSubjectNamePostRequest) Execute() (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return GoutilsRestAPIBaseResponse
func (a *DataplaneApiService) V1DataSubjectSubjectNamePostExecute(r ApiV1DataSubjectSubjectNamePostRequest) (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
