...
func (r ApiV1DataStreamStreamNameConsumerConsumerNameGetRequest) Execute() (ApisStandardResponse, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return ApisStandardResponse
func (a *DataplaneApiService) V1DataStreamStreamNameConsumerConsumerNameGetExecute(r ApiV1DataStreamStreamNameConsumerConsumerNameGetRequest) (ApisStandardResponse, *_nethttp.Response, error) {
	var (
