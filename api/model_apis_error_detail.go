...
func (o *ApisErrorDetail) GetDetail() string {
...
// and a boolean to check if the value has been set.
func (o *ApisErrorDetail) GetDetailOk() (*string, bool) {
	if o == nil || o.Detail == nil {
		return nil, false
	}
...
func (o *ApisErrorDetail) HasDetail() bool {
	if o != nil && o.Detail != nil {
		return true
	}
...
func (o *ApisErrorDetail) SetDetail(v string) {
	o.Detail = &v
}
