...
func (o *ApisAPIRestRespOneJetStream) GetError() GoutilsErrorDetail {
...
func (o *ApisAPIRestRespOneJetStream) GetErrorOk() (*GoutilsErrorDetail, bool) {
	if o == nil || o.Error == nil {
		return nil, false
	}
	return o.Error, true
...
func (o *ApisAPIRestRespOneJetStream) SetError(v GoutilsErrorDetail) {
	o.Error = &v
}
