...
type ApiAliveGetRequest struct {
	ctx        _context.Context
	ApiService *ManagementApiService
}

func (r ApiAliveGetRequest) Execute() (ApisStandardResponse, *_nethttp.Response, error) {
	return r.ApiService.AliveGetExecute(r)
}

/*
AliveGet For liveness check

Will return success to indicate REST API module is live

 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiAliveGetRequest
*/
func (a *ManagementApiService) AliveGet(ctx _context.Context) ApiAliveGetRequest {
	return ApiAliveGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ManagementApiService) AliveGetExecute(r ApiAliveGetRequest) (ApisStandardResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ManagementApiService.AliveGet")
	if err != nil {
...
func (r ApiReadyGetRequest) Execute() (ApisStandardResponse, *_nethttp.Response, error) {
	return r.ApiService.ReadyGetExecute(r)
}

/*
ReadyGet For readiness check
...
*/
func (a *ManagementApiService) ReadyGet(ctx _context.Context) ApiReadyGetRequest {
	return ApiReadyGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//  @return ApisStandardResponse
func (a *ManagementApiService) ReadyGetExecute(r ApiReadyGetRequest) (ApisStandardResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ManagementApiService.ReadyGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
