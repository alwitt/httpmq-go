...
func (r ApiV1AdminAliveGetRequest) Execute() (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
...
func (a *ManagementApiService) V1AdminAliveGetExecute(r ApiV1AdminAliveGetRequest) (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue GoutilsRestAPIBaseResponse
	)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 500 {
			var v GoutilsRestAPIBaseResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (r ApiV1AdminReadyGetRequest) Execute() (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return GoutilsRestAPIBaseResponse
func (a *ManagementApiService) V1AdminReadyGetExecute(r ApiV1AdminReadyGetRequest) (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiV1AdminStreamPostRequest) Execute() (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return GoutilsRestAPIBaseResponse
func (a *ManagementApiService) V1AdminStreamPostExecute(r ApiV1AdminStreamPostRequest) (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
	var (
...
func (r ApiV1AdminStreamStreamNameConsumerConsumerNameDeleteRequest) Execute() (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return GoutilsRestAPIBaseResponse
func (a *ManagementApiService) V1AdminStreamStreamNameConsumerConsumerNameDeleteExecute(r ApiV1AdminStreamStreamNameConsumerConsumerNameDeleteRequest) (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
	var (
...
func (r ApiV1AdminStreamStreamNameConsumerPostRequest) Execute() (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return GoutilsRestAPIBaseResponse
func (a *ManagementApiService) V1AdminStreamStreamNameConsumerPostExecute(r ApiV1AdminStreamStreamNameConsumerPostRequest) (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiV1AdminStreamStreamNameDeleteRequest) Execute() (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return GoutilsRestAPIBaseResponse
func (a *ManagementApiService) V1AdminStreamStreamNameDeleteExecute(r ApiV1AdminStreamStreamNameDeleteRequest) (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiV1AdminStreamStreamNameLimitPutRequest) Execute() (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return GoutilsRestAPIBaseResponse
func (a *ManagementApiService) V1AdminStreamStreamNameLimitPutExecute(r ApiV1AdminStreamStreamNameLimitPutRequest) (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
	var (
...
func (r ApiV1AdminStreamStreamNameSubjectPutRequest) Execute() (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return GoutilsRestAPIBaseResponse
func (a *ManagementApiService) V1AdminStreamStreamNameSubjectPutExecute(r ApiV1AdminStreamStreamNameSubjectPutRequest) (GoutilsRestAPIBaseResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
