...
func (o *ApisAPIRestRespAllJetStreams) GetError() GoutilsErrorDetail {
...
func (o *ApisAPIRestRespAllJetStreams) GetErrorOk() (*GoutilsErrorDetail, bool) {
	if o == nil || o.Error == nil {
		return nil, false
	}
	return o.Error, true
...
func (o *ApisAPIRestRespAllJetStreams) SetError(v GoutilsErrorDetail) {
	o.Error = &v
}
