...
func NewApisStandardResponse(requestId string, success bool) *ApisStandardResponse {
...
func (o *ApisStandardResponse) GetRequestId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ApisStandardResponse) GetRequestIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ApisStandardResponse) SetRequestId(v string) {
	o.RequestId = v
}
